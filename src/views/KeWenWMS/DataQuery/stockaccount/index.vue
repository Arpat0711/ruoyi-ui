...
export default {
  ...
  methods: {
    ...
    getTableList (data) {
      ...
      if (data != null) {
        ...
        if (data.level == 1) {
          ...
          Vue.axios({
            methods: 'GET',
            url: serverUrl + 'system/view/selectDetialItemList',
            headers: {
              'authorization': token
            },
            params: {
    ...
    /** 搜索按钮操作 */
    handleQuery () {
      console.log(this.queryParams.itemName, this.queryParams.itemCode, this.queryParams.batchNumber, this.queryParams.boxCode)
      let that = this
      let token = getToken()
      ...
      let boxCode = this.queryParams.boxCode

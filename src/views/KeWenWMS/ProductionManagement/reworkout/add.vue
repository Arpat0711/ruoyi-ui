<template lang="html">
  <div class="app-container">
    ...
    <el-row :gutter="20">
      <el-col :span="6">单据类型: 返工出库单</el-col>
      <el-col :span="6">调出存储地点: 产成品仓</el-col>
      <el-col :span="12">调入存储地点: 待判定仓</el-col>
    </el-row>
    <hr>
    <el-row>
      <el-col :span="24">
    ...
    <el-dialog title="请选择您要出库的箱" :visible.sync="dialogVisible" :close-on-click-modal="false" @closed="handleCloseModal"
  ...
  methods: {
    getList() {
      ...
      request({
        ...
        data: JSON.stringify({
          ...payload,
          isStocked: 1, boxCode, itemCode, itemName, lotInfo, pageSize: this.pagination.size, pageNum: this.pagination.number,
    ...
    handleSubmit() {
      ...
      if (barcodeIds.length > 0) {
        request({
          url: '/system/TransferOut/add-new-one',
          method: 'post',
          data: JSON.stringify({
            orgId: '1001712062695280', // TODO: should be replace
            barcodeIds

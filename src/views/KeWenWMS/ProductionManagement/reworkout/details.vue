<template lang="html">
  <div class="app-container">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12">调出存储位置: {{ header.transOutWarehouseName }}</el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="6">完成时间: {{ header.finishTime }}</el-col>
      <el-col :span="6">调出人: {{ header.executorName }}</el-col>
...
export default {
  ...
  methods: {
    getList() {
      request({
        url: '/system/TransferOut/find-header',
        method: 'post',
    ...
    handleQuery() {
      ...
      request({
        url: '/system/TransferOut/find-details',
        method: 'post',
        data: JSON.stringify({

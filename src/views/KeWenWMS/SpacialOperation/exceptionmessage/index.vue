...
<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="taskcenterList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态" align="center" prop="status" /> <!-- 0:未进行；1：进行中；2：已完成；3：挂起 -->
      <el-table-column label="执行人" align="center" prop="executor" />
      <el-table-column label="类型" align="center" prop="logtype" />  <!--  0：待办;1:通知 -->
      <el-table-column label="已读" align="center" prop="readstatus" /><!--  0：未读；1：已读 -->

...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      Vue.axios({
        methods: 'GET',
        url: "http://kewen.fgimaxl2.vipnps.vip/system/panel/list",
        // url: "http://192.168.1.26:8082/system/panel/list",
        // url: "http://192.168.1.10:8082/system/panel/list",
        headers: {
          'authorization': token
        },
        params: {}
    ...
    setPanelList (res) {
      ...
      for (let i = 0; i < res.length; i++) {
        tempList.panelName = res[i].panelName         /**托板名 */

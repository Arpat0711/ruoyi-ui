  ...
  <div class="app-container">
    ...
    >
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="日期" prop="clientCode">
            <el-input
              v-model="queryParams.clientCode"
              placeholder="请输入日期"
              clearable
        ...
        <el-col :span="8">
          <el-form-item label="调出组织" prop="clientCode">
            <el-input
              v-model="queryParams.clientCode"
              placeholder="请输入调出组织"
              clearable
        ...
        <el-col :span="8">
          <el-form-item label="调出存储地点" prop="clientName">
            <el-input
              v-model="queryParams.clientName"
              placeholder="请输入调出存储地点"
              clearable
              @keyup.enter.native="handleQuery"
            />
          </el-form-item>
        ...
        <el-col :span="8">
          <el-form-item label="调入组织" prop="clientNick">
            <el-input
              v-model="queryParams.clientNick"
              placeholder="请输入盘调入组织地点"
              clearable
              @keyup.enter.native="handleQuery"
            />
          </el-form-item>
      ...
      >
        <!-- <el-col :span="16" >
          <el-form-item label="盘点执行部门" prop="clientEn">
            <el-input
              v-model="queryParams.clientEn"
              placeholder="请输入盘点执行部门"
              clearable
              @keyup.enter.native="handleQuery"
            />
          </el-form-item>
        ...
        <!-- <el-col :span="8">
          <el-form-item label="处理建议" prop="enableFlag">
            <el-input
              v-model="queryParams.clientEn"
              placeholder="请输入处理建议"
              clearable
        ...
        <el-col :span="8">
          <el-form-item style="line-height: 50%">
            <el-button
              type="primary"
              icon="el-icon-search"
              size="mini"
    ...
    >
      ...
      <el-table-column
        ...
        :show-overflow-tooltip="true"
      />
      <el-table-column label="品名" align="center" prop="clientNick" />
      <el-table-column label="规格" align="center" prop="clientType">
        <template slot-scope="scope">
          <dict-tag
      ...
      <el-table-column label="库位" align="center" prop="tel" />
      <el-table-column label="批号" align="center" prop="contact1" />
      <el-table-column label="库存单位" align="center" prop="contact1Tel" />
      <el-table-column label="帐存数量" align="center" prop="enableFlag">
        <template slot-scope="scope">
          <dict-tag
      ...
      <el-table-column label="实盘数量" align="center" prop="contact1Tel" />
      <el-table-column label="差异数量" align="center" prop="contact1Tel" />
      <el-table-column
        label="操作"
        align="center"
